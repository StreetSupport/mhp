...
content:
  ...
  body: >-
    **Real Change MCR is an alternative giving scheme, which lets the public
    ...
    job interview. The fund is used by Manchester homelessness organisations and
    charities who provide long-term support on the journey to independent
    living. 
    ...
    Read stories of how Real Change MCR has changed people's lives by clicking [here](https://realchangemanchester.co.uk/how-we-help/).


    **Real Change MCR has given over £92,000 in 164 grants since April 2020 alone.**


    ```

    <iframe width="1080" height="608" src="https://www.youtube.com/embed/YoNlXuUoHaM" title="RCM" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    ...
    **O﻿ur frontline partners:**


    ![Image](assets/uploads/f2qep0hxaaaqsjr.jpg "Image")
